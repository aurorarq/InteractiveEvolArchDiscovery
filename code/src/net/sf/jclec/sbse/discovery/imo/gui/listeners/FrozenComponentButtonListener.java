...
public class FrozenComponentButtonListener extends Observable implements ActionListener {

	InteractionController observer;
	int index;
	
	public FrozenComponentButtonListener(InteractionController controller, int index){
