...
public class RemoveSolutionButtonListener extends Observable implements ActionListener {

	InteractionController observer;
	
	public RemoveSolutionButtonListener(InteractionController controller){
